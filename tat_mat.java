...
class tat_mat
{
  ...
  public static int max_sub_mat(int [][] mat)
  {
    int rows = mat.length;
    ...
    for (int i=0;i<colums;i++ )
    {
      ...
      for (int j=i;j<colums;j++ )
      {
        ...
        {
          temp_arr[k] = temp_arr[k] + mat[k][j];
          // System.out.println(temp_arr[k]);
        }
        Best_info best = Best.maximum(temp_arr);
        // System.out.println(temp_arr[k]);
        if (best.best_max>max_sum)
        {
          max_sum = best.best_max;
        }
      }
    }
    return max_sum;
  ...
  public static void main(String[] args)
  {
    int [][] a = {
      ...
      {-3,7,9,-10},
      {-5,20,-30,3}};
    System.out.println(max_sub_mat(a));
